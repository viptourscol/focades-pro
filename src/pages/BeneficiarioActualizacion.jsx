              ...
              <div className="grid md:grid-cols-3 gap-3">
                <label className="grid gap-1 text-sm">
                  ...
                  <select
                    ...
                    disabled={!canUpdate || loadingBanks}
                  ...
                  >
                    <option value="">{loadingBanks ? 'Cargando bancos…' : 'Seleccionar…'}</option>
...
const FileInput = ({ label, file, onChange, disabled = false, isPending = false }) => {
  ...
  return (
    <label className={`block border-2 rounded-xl px-3 py-2 text-sm transition-all duration-300 hover:shadow-sm ${borderColorClass} ${bgColorClass} ${hoverClass}`}>
