-- Corrección: certificado_bancario no es columna directa de inscripciones,
-- está dentro del JSONB soportes. Se elimina la referencia directa errónea.
...
begin
  ...
  -- certificado_bancario no es columna directa: está dentro del JSONB soportes
