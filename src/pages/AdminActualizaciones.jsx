                    ...
                    >
                      ...
                      <td className="px-5 py-3">
                        ...
                        <div className="flex items-center gap-2 flex-wrap">
                          <p className="text-xs text-slate-400">{b?.n_documento || '—'}</p>
                          {b?.convocatoria_id && convocatoriasMap[b.convocatoria_id] && (
                            <span className="inline-flex items-center gap-1 px-1.5 py-0.5 bg-blue-50 text-blue-700 rounded text-[10px] font-medium ring-1 ring-blue-200">
                              <svg className="w-2.5 h-2.5" fill="currentColor" viewBox="0 0 20 20">
                                <path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clipRule="evenodd" />
                              </svg>
                              {convocatoriasMap[b.convocatoria_id]?.nombre || convocatoriasMap[b.convocatoria_id]?.anio}
                            </span>
                          )}
                        </div>
                      </td>
