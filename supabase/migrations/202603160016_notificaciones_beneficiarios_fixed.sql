...
drop policy if exists "Beneficiarios ven solo sus notificaciones" on public.portal_notificaciones_beneficiarios;
...
drop policy if exists "Solo admins pueden insertar notificaciones" on public.portal_notificaciones_beneficiarios;
...
drop policy if exists "Solo admins pueden actualizar notificaciones" on public.portal_notificaciones_beneficiarios;
...
drop trigger if exists trg_portal_notif_updated_at on public.portal_notificaciones_beneficiarios;
...
drop trigger if exists trg_mark_notif_read on public.portal_notificaciones_beneficiarios;
